...
import { TrendingUp, BarChart3, Calculator, ShieldCheck, TrendingDown, AlertTriangle, Zap, ArrowRight, CheckCircle2 } from "lucide-react"
...
export function StepUpSipCalculator() {
  ...
  for (let year = 0; year < tenure; year++) {
    for (let m = 0; m < 12; m++) {
      ...
      futureValue += monthlySip * Math.pow(1 + monthlyRate, totalMonths - (year * 12 + m))
    }
  ...
  return (
    <div className="mx-auto max-w-4xl">
      <div className="mb-6 text-center">
        <h2 className="font-sans text-2xl font-bold text-foreground sm:text-3xl">Step-Up SIP Calculator</h2>
          ...
          {stage === "results" && (
            <motion.div key="results" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-8">
              <div className="text-center">
                ...
                <h3 className="font-sans text-2xl font-bold text-card-foreground">Your Step-Up SIP could grow to</h3>
              </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <ul className="mt-2 space-y-1 text-sm text-primary/80">
                      <li>Starting SIP: {formatCurrency(monthlyInvestment)}/month</li>
                      <li>Annual Step-Up: {annualStepUp}%</li>
