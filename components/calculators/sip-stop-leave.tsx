...
import { TrendingUp, BarChart3, Calculator, TrendingDown, AlertTriangle, Zap, ArrowRight, CheckCircle2, PauseCircle, PlayCircle } from "lucide-react"
...
export function SipStopLeaveCalculator() {
  ...
  const trueWealthData: TrueWealth = {
    maturityValue: Math.round(finalCorpus),
    totalInvested,
    gains: estimatedReturns,
    holdingYears: investYears + growYears,
    taxType: (investYears + growYears) >= 1 ? "equity-ltcg" : "equity-stcg",
  }
